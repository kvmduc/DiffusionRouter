...
from guided_diffusion.train_util import DistillLoop_COCO_v2
...
def main():
    ...
    if dist.get_rank() == 0:
        name = f'Versatile_{args.dataset_name}_Distill_{args.lambda_values[0]}_{args.lambda_values[1]}_{args.lambda_values[2]}_lr{args.lr}'
...
def create_argparser():
    ...
    parser.add_argument(
        "--dataset_name", 
        type=str, 
        choices=["edges_shoes_grayscale", "face_sketch_segment", "face_sketch_segment_latent", "coco_multimodal_latent", "coco_multimodal_latent_v2"], 
    )
    parser.add_argument(
        "--model_path", 
        type=str, 
