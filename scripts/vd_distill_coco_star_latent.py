...
from guided_diffusion.train_util import DistillLoop_COCO
...
def create_argparser():
    ...
    parser.add_argument(
        "--dataset_name", 
        type=str, 
        choices=["edges_shoes_grayscale", "face_sketch_segment", "face_sketch_segment_latent", "coco_multimodal_latent"], 
    )
    parser.add_argument(
        "--model_path", 
        type=str, 
