...
def main():
    ...
    if dist.get_rank() == 0:
        if args.dataset_name == 'face_sketch_segment':
            name = 'Versatile_FaceSketchSegment_x256' 
        elif args.dataset_name == 'coco_multimodal':
            name = 'Versatile_CocoMultiModal_x256'
        elif args.dataset_name == 'face_sketch_segment_latent':
            name = 'Versatile_FaceSketchSegment_x256_latent_small'
        elif args.dataset_name == 'coco_multimodal_v2' or args.dataset_name == 'coco_multimodal_latent_v2':
            name = 'Versatile_CocoMultiModal_x256_v2'
...
def create_argparser():
    ...
    parser.add_argument(
        "--dataset_name", 
        type=str, 
        choices=["edges_shoes_grayscale", "face_sketch_segment", "face_sketch_segment_latent", "coco_multimodal", "coco_multimodal_v2", "coco_multimodal_latent_v2"], 
    )
    parser.add_argument(
        "--no_clip_denoised",
        dest="clip_denoised",
